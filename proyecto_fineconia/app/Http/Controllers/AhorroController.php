...
class AhorroController extends Controller
{
        ...
        foreach ($categories as $slug => $label) {
            ...
            switch ($slug) {
                case 'presupuesto':
                    ...
                    break;
                case 'compras':
                    $keywords = ['compra', 'compras', 'compras inteligentes'];
                    break;
                case 'energia':
                    $keywords = ['energia', 'servicio', 'energía'];
                    break;
                case 'metas':
                    $keywords = ['meta', 'metas', 'ahorro'];
                    break;
                case 'familiar':
                    $keywords = ['familiar', 'familia'];
                    break;
            }
    ...
    // Aqui la logica para las gráficas de ahorro
    ...
    public function apiObjetivos(Request $request)
    {
        $userId = Auth::id();
        ...
        if ($request->filled('desde')) {
            $query->whereDate('fecha_hasta', '>=', $request->input('desde'));
        }

        if ($request->filled('hasta')) {
            $query->whereDate('fecha_hasta', '<=', $request->input('hasta'));
        }
